...
public class AccountController {
  ...
  public Account updateAccount(@RequestBody(required = false) Account account,@RequestParam String amount,@RequestParam(required = false) Boolean isCredit) throws IOException, JSONException, AccountException {
